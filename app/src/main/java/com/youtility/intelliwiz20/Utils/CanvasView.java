...
public class CanvasView extends View
{
	...
	protected void onDraw(Canvas canvas) {
        ...
        if (this.bitmap != null) {
            ...
            Bitmap resizedBitmap=Bitmap.createScaledBitmap(this.bitmap, (this.bitmap.getWidth()/2),(this.bitmap.getHeight()/2), true );

            //Bitmap resizedBitmap=Bitmap.createBitmap(this.bitmap, 0,0, (this.bitmap.getWidth())/2, (this.bitmap.getHeight())/2, matrix, true);

            canvas.drawBitmap(resizedBitmap, 0F, 0F, emptyPaint);
    ...
    public void drawBitmap(Bitmap bitmap, Matrix matrix, Paint paint) {
        /*this.bitmap = bitmap;
        this.invalidate();*/
        this.drawBitmap(bitmap,matrix, emptyPaint);
    }
