...
/**
 * Created by PrashantD on 28/12/17.
 */
...
public class BadgeDrawable extends Drawable {
    ...
    {
        float mTextSize = context.getResources().getDimension(R.dimen.text_size12dp);
        ...
        mBadgePaint1.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.colorGray));
