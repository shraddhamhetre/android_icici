...
package com.youtility.intelliwiz20.android.encode;
...
import com.youtility.intelliwiz20.android.FinishListener;
import com.youtility.intelliwiz20.android.Intents;
...
public final class EncodeActivity extends Activity {
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    super.onCreateOptionsMenu(menu);
		// menu.add(Menu.NONE, SHARE_MENU, Menu.NONE,
		// R.string.menu_share).setIcon(android.R.drawable.ic_menu_share);
		// int encodeNameResource = qrCodeEncoder.isUseVCard() ?
